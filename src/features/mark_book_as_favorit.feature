Feature:
  User story1, 2: Give possibility to mark a book from the website catalog as favorit

Background:
    Given I'm on a "Läslistan" webpage

  Scenario: A1.1, A1.2, A2.1, A2.2
  Add a book as my favorit and then remove it from there
